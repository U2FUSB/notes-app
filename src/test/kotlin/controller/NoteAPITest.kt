...
class NoteAPITest {
    ...
    @Nested
    inner class ListArchivedActiveNotes {
        @Test
    ...
    @Nested
    inner class ListPriorityOfNotes {
        @Test
...
/*        @Test
    ...
    @Nested
    inner class SearchingNotesByTitle {
        @Test
        fun allNotesAreFoundThatContainProvidedTitle() {
            assertTrue(populatedNotes!!.searchByTitle("App").contains("Code"))
            assertTrue(populatedNotes!!.searchByTitle("App").contains("Test"))
        }
        @Test
        fun `searching is case sensitive`() {
            assertFalse(populatedNotes!!.searchByTitle("App").contains("code"))
            assertFalse(populatedNotes!!.searchByTitle("App").contains("test"))
        }
        @Test
        fun `searching does just provided searched notes`() {
            assertFalse(populatedNotes!!.searchByTitle("App").contains("Summer Holiday to France"))
            assertFalse(populatedNotes!!.searchByTitle("App").contains("Learning Kotlin"))
        }
        @Test
        fun `searching reacts on empty searches`() {
            assertTrue(populatedNotes!!.searchByTitle("notInAnyNote").isEmpty())
        }
    }
